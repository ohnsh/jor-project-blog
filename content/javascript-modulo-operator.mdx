...
*This blog is a project from Josh Comeau's [Joy of React](https://joyofreact.com) course. This post, including the interactive illustrations, was provided by Josh. (One of our assignments was to implement the animations within those illustrations.) See [Adapting Parcel Projects for Next.js](/adapting-parcel-projects) for more. —John*
